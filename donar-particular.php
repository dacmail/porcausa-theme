					...
					<form id="donateForm">
						...
						<div class="step step-2">
							...
							<fieldset id="opcion-pago">
								...
								<label for="drMethod2"><input type="radio" id="drMethod2" name="drMethod" value="1044" checked onclick="jQuery('#bankDetailsSpan').show();"> Domiciliación bancaria (IBAN + Entidad + Oficina + DC + Cuenta)</label>
							</fieldset>
							...
							<fieldset>
								<button type="button" id="btnDonationSubmit" class="btn btn-next btn-primary">Hacer una donación</button>
							</fieldset>
						</div>
					</form>
				</div>
